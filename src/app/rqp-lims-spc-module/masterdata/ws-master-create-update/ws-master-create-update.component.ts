...
@Component({
  selector: 'app-ws-master-create-update',
  standalone: false,
  templateUrl: './ws-master-create-update.component.html',
  styleUrl: './ws-master-create-update.component.scss'
})
export class WsMasterCreateUpdateComponent 
implements OnInit {
  isReadOnly = true;
  isUpdate = false;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<WsMasterCreateUpdateComponent>,
  ...
  onloadDFListDropDown() {
    this.isLoading = true;
    this.wsMasterService.getDropDownList(this.cookieService.get('buCode')).subscribe((data: any) => {
      console.log(data);
  ...
  onLoadFormValue() {
    ...
    this.apiService
      .sendRequest(apiEndPoints.WsmasterLoadUpdatePage, 'POST', params)
      .subscribe((data: any) => {
        if (data.data == null) {
          this.isLoading = false;
            ...
            .subscribe((data: any) => {
              if (data.errorInfo != null) {
                ...
                timer(2000)
                  ...
                  .subscribe(() => {
                    this.route.navigateByUrl('/rqpquailtyui/lims-spc/ws-master-home-page');
                  });
              }
