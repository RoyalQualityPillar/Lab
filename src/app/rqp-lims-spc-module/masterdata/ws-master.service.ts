...
export class WsMasterService {
     ...
     private API_URL = environment.apiBaseURL;
        ...
        let fetchAllBusinessUnitInfoApiUrl =
          this.API_URL + 'limspc/ws_fields/get-by-code-all' + queryParams;
       ...
       generateReport(
        ...
        return this.http.post(
          this.API_URL +
            `limspc/ws_fields-report?templateName=${templateName}&uc0001=${uc0001}&moduleCode=${moduleCode}`,
          ''
        );
      }
          }
