...
@Component({
  selector: 'app-field-master-create-update',
  standalone: false,
  templateUrl: './field-master-create-update.component.html',
  styleUrl: './field-master-create-update.component.scss'
})
export class FieldMasterCreateUpdateComponent 
...
implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<FieldMasterCreateUpdateComponent>,
  ...
  onLoadFormValue() {
    ...
    this.apiService
      .sendRequest(apiEndPoints.FieldmasterLoadUpdatePage, 'POST', params)
      .subscribe((data: any) => {
        if (data.data == null) {
          this.isLoading = false;
            ...
            .subscribe((data: any) => {
              if (data.errorInfo != null) {
                ...
                timer(2000)
                  ...
                  .subscribe(() => {
                    this.route.navigateByUrl('/rqpquailtyui/lims-spc/field-master-home-page');
                  });
              }
