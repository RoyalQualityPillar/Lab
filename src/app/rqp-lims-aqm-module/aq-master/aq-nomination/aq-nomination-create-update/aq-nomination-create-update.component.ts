...
@Component({
  selector: 'app-aq-nomination-create-update',
  standalone: false,
  templateUrl: './aq-nomination-create-update.component.html',
  styleUrl: './aq-nomination-create-update.component.scss'
})
export class AqNominationCreateUpdateComponent   implements OnInit, OnDestroy {
  isReadOnly = true;
  isUpdate = false;
  ...
  constructor(
    ...
    private AqNominationService: AqNominationService,
    private remoteLoader: RemoteComponentLoaderService,
    private cookieService: CookieService,
    private apiService: ApiService,
    private route: Router,
    private notificationService: NotificationService,
    public dialogRef: MatDialogRef<AqNominationCreateUpdateComponent>,
  ...
  onLoadStatusDropDown() {
    this.isLoading = true;
    this.AqNominationService.getDropDownList().subscribe((data: any) => {
  ...
  onLoadFormValue() {
    ...
    const params = { UC0001 };
    this.apiService
      .sendRequest(apiEndPoints.AqnominationLoadUpdatePage, 'POST', params)
      .subscribe((data: any) => {
      ...
      .subscribe((data: any) => {
        if (data.errorInfo != null) {
          ...
          timer(2000)
            ...
            .subscribe(() => {
              this.route.navigateByUrl('./rqplabui/lims-aq/aq-nomination-home-page');
            });
        }
