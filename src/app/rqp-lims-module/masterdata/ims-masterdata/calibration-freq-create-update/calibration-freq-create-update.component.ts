...
@Component({
  selector: 'app-calibration-freq-create-update',
  standalone: false,
  templateUrl: './calibration-freq-create-update.component.html',
  styleUrl: './calibration-freq-create-update.component.scss'
})
export class CalibrationFreqCreateUpdateComponent 
  ...
  implements OnInit {
    ...
    constructor(
      ...
      public dialogRef: MatDialogRef<CalibrationFreqCreateUpdateComponent>,
