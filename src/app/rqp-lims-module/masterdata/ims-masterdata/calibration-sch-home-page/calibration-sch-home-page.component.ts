...
import { CalibrationSchCreateUpdateComponent } from '../calibration-sch-create-update/calibration-sch-create-update.component';
 ...
 implements OnInit, AfterViewInit {
  ...
  async onActiveSelectAuditRow() {
    let tableData = [
      ...
      { labelName: 'Calibration Schedule No', value: this.selectedRow.uc0001 },
      { labelName: 'Module Code', value: this.selectedRow.ff0001 },
    ...
    const rows = apiResponse.map((item) => {
      return {
        fields: [
          ...
          { labelName: 'Calibration Schedule No', value: item.uc0001 },
          { labelName: 'Module Code', value: item.ff0001 },
  ...
  columnConfig = {
    action: 'Action',
    uc0001: 'Calibration Schedule No',
    ff0001: 'Module Code',
    ff0002: 'Data Sheet No',
    ff0004: 'Organization Unit Code',
    ff0005: 'Schedule Count Type',
    status: 'Status',
    version: 'Version',
    createdon: 'CreatedOn',
    createdby: 'CreatedBy',
