...
@Component({
  selector: 'app-sample-set-master-create-update',
  standalone: false,
  templateUrl: './sample-set-master-create-update.component.html',
  styleUrl: './sample-set-master-create-update.component.scss'
})
export class SampleSetMasterCreateUpdateComponent implements OnInit {
  isReadOnly = true;
  isUpdate = false;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<SampleSetMasterCreateUpdateComponent>,
  ...
  onLoadFormValue() {
    ...
    this.apiService
      .sendRequest(apiEndPoints.SampleSetLoadUpdatePage, 'POST', params)
      .subscribe((data: any) => {
        if (data.data == null) {
          this.isLoading = false;
