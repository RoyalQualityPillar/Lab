...
export class SampleSetMasterService {
 ...
 private API_URL = environment.apiBaseURL;
      ...
      let fetchAllBusinessUnitInfoApiUrl =
        this.API_URL + 'at/sampleset-master/get-by-code-all' + queryParams;
     ...
     getDropDownList(unitCode: any) {
      ...
      generateReport(
          ...
          return this.http.post(
            this.API_URL +
              `at/sampleset-master-report?templateName=${templateName}&uc0001=${uc0001}&moduleCode=${moduleCode}`,
            ''
          );
