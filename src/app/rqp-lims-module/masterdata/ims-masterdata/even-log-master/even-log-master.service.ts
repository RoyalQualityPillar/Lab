...
export class EvenLogMasterService {
  ...
  private API_URL = environment.apiBaseURL;
             ...
             onCreate(body: any) {
               ...
               let createUserURL = this.API_URL + 'at/evenlog-master/save-update';
               const httpOptions = {
         ...
         let fetchAllBusinessUnitInfoApiUrl =
           this.API_URL + 'at/evenlog-master/get-by-code-all' + queryParams;
      ...
      generateReport(
          ...
          this.API_URL +
          `at/evenlog-master-report?templateName=${templateName}&uc0001=${uc0001}&moduleCode=${moduleCode}`,
          ''
              );
