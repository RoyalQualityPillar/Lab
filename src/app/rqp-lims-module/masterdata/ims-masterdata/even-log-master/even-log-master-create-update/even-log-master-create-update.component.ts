...
@Component({
  selector: 'app-even-log-master-create-update',
  standalone: false,
  templateUrl: './even-log-master-create-update.component.html',
  styleUrl: './even-log-master-create-update.component.scss'
})
export class EvenLogMasterCreateUpdateComponent implements OnInit {
    isReadOnly = true;
    isUpdate = false;
    ...
    constructor(
      ...
      public dialogRef: MatDialogRef<EvenLogMasterCreateUpdateComponent>,
    ...
    onloadDFListDropDown() {
      this.isLoading = true;
      this.evenLogMasterService.getDropDownList(this.cookieService.get('buCode')).subscribe((data: any) => {
        console.log(data);
    ...
    onLoadFormValue() {
      ...
      this.apiService
        .sendRequest(apiEndPoints.EvenLogLoadUpdatePage, 'POST', params)
        .subscribe((data: any) => {
          if (data.data == null) {
            this.isLoading = false;
