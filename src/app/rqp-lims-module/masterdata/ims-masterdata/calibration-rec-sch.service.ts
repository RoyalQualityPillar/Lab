...
export class CalibrationRecSchService {
   ...
   private API_URL = environment.apiBaseURL;
      ...
      let fetchAllBusinessUnitInfoApiUrl =
        this.API_URL + 'limsm-im/crs_master/get-by-code-all' + queryParams;
      ...
      return this.http.get(fetchAllBusinessUnitInfoApiUrl);
         ...
         generateReport(
                  ...
                  return this.http.post(
                    this.API_URL +
                      `limsm-im/crs-master-report?templateName=${templateName}&uc0001=${uc0001}&moduleCode=${moduleCode}`,
                    ''
                  );
