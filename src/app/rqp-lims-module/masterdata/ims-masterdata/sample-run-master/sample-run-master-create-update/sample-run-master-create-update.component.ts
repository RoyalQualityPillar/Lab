...
@Component({
  selector: 'app-sample-run-master-create-update',
  standalone: false,
  templateUrl: './sample-run-master-create-update.component.html',
  styleUrl: './sample-run-master-create-update.component.scss'
})
export class SampleRunMasterCreateUpdateComponent implements OnInit {
    isReadOnly = true;
    isUpdate = false;
    ...
    constructor(
      ...
      public dialogRef: MatDialogRef<SampleRunMasterCreateUpdateComponent>,
    ...
    onloadDFListDropDown() {
      this.isLoading = true;
      this.sampleRunMasterService.getDropDownList(this.cookieService.get('buCode')).subscribe((data: any) => {
        console.log(data);
    ...
    onLoadFormValue() {
      ...
      this.apiService
        .sendRequest(apiEndPoints.SampleRunLoadUpdatePage, 'POST', params)
        .subscribe((data: any) => {
          if (data.data == null) {
            this.isLoading = false;
