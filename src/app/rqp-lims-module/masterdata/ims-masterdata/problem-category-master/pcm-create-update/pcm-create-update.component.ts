...
@Component({
  selector: 'app-pcm-create-update',
  standalone: false,
  templateUrl: './pcm-create-update.component.html',
  styleUrl: './pcm-create-update.component.scss'
})
export class PcmCreateUpdateComponent implements OnInit {
    isReadOnly = true;
    isUpdate = false;
    ...
    constructor(
      ...
      public dialogRef: MatDialogRef<PcmCreateUpdateComponent>,
