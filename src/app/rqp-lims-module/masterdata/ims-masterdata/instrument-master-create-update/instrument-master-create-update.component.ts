...
@Component({
  selector: 'app-instrument-master-create-update',
  standalone: false,
  templateUrl: './instrument-master-create-update.component.html',
  styleUrl: './instrument-master-create-update.component.scss'
})
export class InstrumentMasterCreateUpdateComponent implements OnInit, OnDestroy {
  isReadOnly = true;
  isUpdate = false;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<InstrumentMasterCreateUpdateComponent>,
 ...
 ngOnInit(): void {
  ...
  onloadDropDown() {
   ...
   onloadDeptListDropDown() {
    this.isLoading = true;
    this.instrumentMasterService.getDropDownDeptList(this.cookieService.get('buCode')).subscribe((data: any) => {
      console.log(data);
  ...
  onLoadStatusDropDown() {
    this.isLoading = true;
    this.instrumentMasterService.getDropDownList().subscribe((data: any) => {
  ...
  onLoadFormValue() {
    ...
    const params = { UC0001 };
    this.apiService
      .sendRequest(apiEndPoints.instrumentMasterLoadUpdatePage, 'POST', params)
      .subscribe((data: any) => {
