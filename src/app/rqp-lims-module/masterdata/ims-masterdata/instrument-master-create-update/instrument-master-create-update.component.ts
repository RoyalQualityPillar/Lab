...
export class InstrumentMasterCreateUpdateComponent 
...
implements OnInit {
  ...
  onloadDFListDropDown() {
    this.isLoading = true;
    this.instrumentMasterService.getDropDownList(this.cookieService.get('buCode')).subscribe((data: any) => {
      console.log(data);
