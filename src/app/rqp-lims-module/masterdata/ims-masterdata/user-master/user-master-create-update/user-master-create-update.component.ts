...
@Component({
  selector: 'app-user-master-create-update',
  standalone: false,
  templateUrl: './user-master-create-update.component.html',
  styleUrl: './user-master-create-update.component.scss'
})
export class UserMasterCreateUpdateComponent implements OnInit {
    isReadOnly = true;
    isUpdate = false;
    ...
    constructor(
      ...
      public dialogRef: MatDialogRef<UserMasterCreateUpdateComponent>,
    ...
    onLoadFormValue() {
      ...
      this.apiService
        .sendRequest(apiEndPoints.UserLoadUpdatePage, 'POST', params)
        .subscribe((data: any) => {
          if (data.data == null) {
            this.isLoading = false;
