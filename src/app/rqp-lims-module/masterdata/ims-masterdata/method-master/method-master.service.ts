...
export class MethodMasterService {
 ...
 private API_URL = environment.apiBaseURL;
           ...
           onCreate(body: any) {
             ...
             let createUserURL = this.API_URL + 'at/method-master/save-update';
             const httpOptions = {
       ...
       let fetchAllBusinessUnitInfoApiUrl =
         this.API_URL + 'at/method-master/get-by-code-all' + queryParams;
    ...
    //  }
     generateReport(
              ...
              return this.http.post(
                this.API_URL +
                  `at/method-master-report?templateName=${templateName}&uc0001=${uc0001}&moduleCode=${moduleCode}`,
                ''
              );
