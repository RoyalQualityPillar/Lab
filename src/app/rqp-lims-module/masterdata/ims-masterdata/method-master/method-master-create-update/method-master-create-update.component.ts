...
@Component({
  selector: 'app-method-master-create-update',
  standalone: false,
  templateUrl: './method-master-create-update.component.html',
  styleUrl: './method-master-create-update.component.scss'
})
export class MethodMasterCreateUpdateComponent implements OnInit {
    isReadOnly = true;
    isUpdate = false;
    ...
    constructor(
      ...
      public dialogRef: MatDialogRef<MethodMasterCreateUpdateComponent>,
    ...
    //   this.isLoading = true;
    //   this.methodMasterService.getDropDownList(this.cookieService.get('buCode')).subscribe((data: any) => {
    //     console.log(data);
    ...
    onLoadFormValue() {
      ...
      this.apiService
        .sendRequest(apiEndPoints.MethodLoadUpdatePage, 'POST', params)
        .subscribe((data: any) => {
          if (data.data == null) {
            this.isLoading = false;
