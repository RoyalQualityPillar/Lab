...
@Component({
  selector: 'app-sample-test-plan-vs-create-update',
  standalone: false,
  templateUrl: './sample-test-plan-vs-create-update.component.html',
  styleUrl: './sample-test-plan-vs-create-update.component.scss'
})
export class SampleTestPlanVsCreateUpdateComponent    implements OnInit {
  isReadOnly = true;
  isUpdate = false;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<SampleTestPlanVsCreateUpdateComponent>,
  ...
  onLoadFormValue() {
    ...
    this.apiService
      .sendRequest(apiEndPoints.SamTpVsLoadUpdatePage, 'POST', params)
      .subscribe((data: any) => {
        if (data.data == null) {
          this.isLoading = false;
