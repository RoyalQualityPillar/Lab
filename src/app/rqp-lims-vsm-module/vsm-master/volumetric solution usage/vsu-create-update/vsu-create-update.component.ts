...
@Component({
  selector: 'app-vsu-create-update',
  standalone: false,
  templateUrl: './vsu-create-update.component.html',
  styleUrl: './vsu-create-update.component.scss'
})
export class VsuCreateUpdateComponent  implements OnInit {
  isReadOnly = true;
  isUpdate = false;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<VsuCreateUpdateComponent >,
  ...
  onLoadFormValue() {
    ...
    this.apiService
      .sendRequest(apiEndPoints.volsolLoadUpdatePage, 'POST', params)
      .subscribe((data: any) => {
        if (data.data == null) {
          this.isLoading = false;
  ...
  setFormValue() {
    ...
    this.DepartmentMaster.controls['ff0014'].setValue(this.formData.ff0014);
     this.DepartmentMaster.controls['ff0015'].setValue(this.formData.ff0014);
