...
@Component({
  selector: 'app-spm-create-update',
  standalone: false,
  templateUrl: './spm-create-update.component.html',
  styleUrl: './spm-create-update.component.scss'
})
export class SpmCreateUpdateComponent    implements OnInit {
  isReadOnly = true;
  isUpdate = false;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<SpmCreateUpdateComponent>,
