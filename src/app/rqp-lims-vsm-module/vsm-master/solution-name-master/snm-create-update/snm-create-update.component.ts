...
@Component({
  selector: 'app-snm-create-update',
  standalone: false,
  templateUrl: './snm-create-update.component.html',
  styleUrl: './snm-create-update.component.scss'
})
export class SnmCreateUpdateComponent implements OnInit {
  isReadOnly = true;
  isUpdate = false;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<SnmCreateUpdateComponent>,
  ...
  onLoadFormValue() {
    ...
    this.apiService
      .sendRequest(apiEndPoints.SolNaLoadUpdatePage, 'POST', params)
      .subscribe((data: any) => {
        if (data.data == null) {
          this.isLoading = false;
