...
@Component({
  selector: 'app-sample-regestration-vs-create-update',
  standalone: false,
  templateUrl: './sample-regestration-vs-create-update.component.html',
  styleUrl: './sample-regestration-vs-create-update.component.scss'
})
export class SampleRegestrationVsCreateUpdateComponent    implements OnInit {
  isReadOnly = true;
  isUpdate = false;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<SampleRegestrationVsCreateUpdateComponent>,
  ...
  onLoadFormValue() {
    ...
    this.apiService
      .sendRequest(apiEndPoints.SamRegVsLoadUpdatePage, 'POST', params)
      .subscribe((data: any) => {
        if (data.data == null) {
          this.isLoading = false;
