...
@Component({
  selector: 'app-stm-create-update',
  standalone: false,
  templateUrl: './stm-create-update.component.html',
  styleUrl: './stm-create-update.component.scss'
})
export class StmCreateUpdateComponent  implements OnInit {
  isReadOnly = true;
  isUpdate = false;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<StmCreateUpdateComponent>,
  ...
  onLoadFormValue() {
    ...
    this.apiService
      .sendRequest(apiEndPoints.SolTeLoadUpdatePage, 'POST', params)
      .subscribe((data: any) => {
        if (data.data == null) {
          this.isLoading = false;
