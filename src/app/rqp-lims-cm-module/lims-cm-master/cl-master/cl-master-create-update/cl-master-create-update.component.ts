...
@Component({
  selector: 'app-cl-master-create-update',
  templateUrl: './cl-master-create-update.component.html',
  styleUrls: ['./cl-master-create-update.component.scss'],
  standalone: false,
})
export class ClMasterCreateUpdateComponent implements OnInit {
  isReadOnly = true;
  isUpdate = false;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ClMasterCreateUpdateComponent>,
  ...
  onUpdate() {
    ...
    this.apiService
      .sendRequest(
        apiEndPoints.GlMasterCreateUpdate,
        'POST',
        params,
