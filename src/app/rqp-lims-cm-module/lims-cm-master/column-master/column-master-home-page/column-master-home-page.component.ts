...
export class ColumnMasterHomePageComponent {
  ...
  onActiveSelectAuditRow() {
    let tableData = [
      ...
      { labelName: 'Manfacture Code', value: this.selectedRow.ff0002 },
      { labelName: 'Mfg. Part No', value: this.selectedRow.ff0003 },
      {
        labelName: 'Film thickness/Particlesize',
        value: this.selectedRow.ff0004,
      },
      { labelName: 'Length', value: this.selectedRow.ff0005 },
      { labelName: 'inner diameter', value: this.selectedRow.ff0006 },
      { labelName: 'outer diameter', value: this.selectedRow.ff0007 },
      { labelName: 'Application type', value: this.selectedRow.ff0008 },
  ...
  columnConfig = {
    ...
    uc0001: 'Column No',
    ff0001: 'Column Name',
    ff0002: 'Manfacture Code',
    ff0003: 'Mfg. Part No',
    ff0004: 'Film thickness/Particlesize',
    ff0005: 'Length',
    ff0006: 'inner diameter',
    ff0007: 'outer diameter',
    ff0008: 'Application type',
    ff0009: 'Make',
