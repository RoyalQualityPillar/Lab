...
@Component({
    selector: 'app-mrssst-reviewer-save',
    templateUrl: './mrssst-reviewer-save.component.html',
    styleUrls: ['./mrssst-reviewer-save.component.scss'],
    standalone: false
})
export class MrssstReviewerSaveComponent implements OnInit, OnDestroy {
  public redirectUrl: string = '/excel/mrssst-module-home-page';
