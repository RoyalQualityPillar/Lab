...
@Component({
  selector: 'app-mrsle-reviewer-save',
  templateUrl: './mrsle-reviewer-save.component.html',
  styleUrls: ['./mrsle-reviewer-save.component.scss'],
  standalone: false,
})
export class MrsleReviewerSaveComponent implements OnInit, OnDestroy {
  public redirectUrl: string = '/excel/mrsle-module-home-page';
    ...
    this.rqwMaterialAssayService.save(sendValue).subscribe((data) => {
      if (data.errorInfo) {
        ...
        timer(2000)
          .pipe(takeUntil(this.destroy$))
          .subscribe(() => {
            this.router.navigateByUrl('/excel/mrsle-home');
          });
      }
    });
  }
