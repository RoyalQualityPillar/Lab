...
@Component({
  selector: 'app-mrsle-init',
  templateUrl: './mrsle-init.component.html',
  styleUrls: ['./mrsle-init.component.scss'],
  standalone: false,
})
export class MrsleInitComponent implements OnInit, OnDestroy {
  @ViewChild('linechart') linechart: ChartComponent;
  public linechartOptions: Partial<linechartOptions>;
  public ViewDetailForm: FormGroup;
  public areaArray: number[] = [];
  public concentrationArray: number[] = [];
