...
@Component({
  selector: 'app-rasi-reviewer-save',
  templateUrl: './rasi-reviewer-save.component.html',
  styleUrls: ['./rasi-reviewer-save.component.scss'],
  standalone: false
})
export class RasiReviewerSaveComponent implements OnInit, OnDestroy {
  public redirectUrl: string = '/rqpquailtyui/excel/rasi-home';
  ...
  onLoadNextStageData() {
    ...
    this.rqwMaterialAssayService
      ...
      .subscribe((data: any) => {
        this.toolbarService.nextStageListData = data.data.nstage;
        this.toolbarService.previousStageListData = data.data.pstage;
