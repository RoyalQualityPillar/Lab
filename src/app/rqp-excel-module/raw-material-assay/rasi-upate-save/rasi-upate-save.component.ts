...
@Component({
  selector: 'app-rasi-upate-save',
  templateUrl: './rasi-upate-save.component.html',
  styleUrls: ['./rasi-upate-save.component.scss'],
  standalone: false,
})
export class RasiUpateSaveComponent implements OnInit, OnDestroy {
  ...
  public handleCommentsForm(event: any): void {
