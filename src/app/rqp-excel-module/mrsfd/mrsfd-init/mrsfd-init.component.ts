...
@Component({
  selector: 'app-mrsfd-init',
  templateUrl: './mrsfd-init.component.html',
  styleUrls: ['./mrsfd-init.component.scss'],
  standalone: false,
})
export class MrsfdInitComponent implements OnInit, OnDestroy {
