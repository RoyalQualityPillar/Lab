...
@Component({
  selector: 'app-ras2-init',
  templateUrl: './ras2-init.component.html',
  styleUrls: ['./ras2-init.component.scss'],
  standalone: false,
})
export class Ras2InitComponent implements OnInit, OnDestroy {
