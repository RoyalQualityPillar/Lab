...
@Component({
  selector: 'app-ras2-reviewer-save',
  templateUrl: './ras2-reviewer-save.component.html',
  styleUrls: ['./ras2-reviewer-save.component.scss'],
  standalone: false,
})
export class Ras2ReviewerSaveComponent implements OnInit, OnDestroy {
  public redirectUrl: string = '/excel/ras2-module-home-page';
  ...
  calculateReturnPayload() {
    console.log(this.UserRequirementForm.value.comments);
    return {
      data: 'returnData',
