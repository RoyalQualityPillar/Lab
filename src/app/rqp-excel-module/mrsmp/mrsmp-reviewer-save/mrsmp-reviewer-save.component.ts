...
@Component({
    selector: 'app-mrsmp-reviewer-save',
    templateUrl: './mrsmp-reviewer-save.component.html',
    styleUrls: ['./mrsmp-reviewer-save.component.scss'],
    standalone: false
})
export class MrsmpReviewerSaveComponent implements OnInit, OnDestroy {
  public redirectUrl: string = '/excel/mrsmp-module-home-page';
