...
@Component({
  selector: 'app-mrsmp-init',
  templateUrl: './mrsmp-init.component.html',
  styleUrls: ['./mrsmp-init.component.scss'],
  standalone: false,
})
export class MrsmpInitComponent implements OnInit, OnDestroy {
