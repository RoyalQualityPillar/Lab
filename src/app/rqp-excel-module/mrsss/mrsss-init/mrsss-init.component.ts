...
@Component({
  selector: 'app-mrsss-init',
  templateUrl: './mrsss-init.component.html',
  styleUrls: ['./mrsss-init.component.scss'],
  standalone: false,
})
export class MrsssInitComponent implements OnInit, OnDestroy {
