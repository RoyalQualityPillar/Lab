...
@Component({
    selector: 'app-mrsss-reviewer-save',
    templateUrl: './mrsss-reviewer-save.component.html',
    styleUrls: ['./mrsss-reviewer-save.component.scss'],
    standalone: false
})
export class MrsssReviewerSaveComponent implements OnInit, OnDestroy {
  public redirectUrl: string = '/excel/mrsss-module-home-page';
