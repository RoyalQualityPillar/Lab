...
@Component({
  selector: 'app-mrsa-reviewer-save',
  templateUrl: './mrsa-reviewer-save.component.html',
  styleUrls: ['./mrsa-reviewer-save.component.scss'],
  standalone: false,
})
export class MrsaReviewerSaveComponent implements OnInit, OnDestroy {
  public redirectUrl: string = '/excel/mrsa-module-home-page';
