...
@Component({
  selector: 'app-mrsa-init',
  templateUrl: './mrsa-init.component.html',
  styleUrls: ['./mrsa-init.component.scss'],
  standalone: false,
})
export class MrsaInitComponent implements OnInit, OnDestroy {
