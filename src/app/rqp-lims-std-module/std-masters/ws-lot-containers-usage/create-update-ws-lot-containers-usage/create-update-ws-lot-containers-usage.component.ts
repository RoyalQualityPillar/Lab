...
@Component({
  selector: 'app-create-update-ws-lot-containers-usage',
  standalone: false,
  templateUrl: './create-update-ws-lot-containers-usage.component.html',
  styleUrl: './create-update-ws-lot-containers-usage.component.scss'
})
export class CreateUpdateWsLotContainersUsageComponent implements OnInit, OnDestroy {
  isReadOnly = true;
  isUpdate = false;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<CreateUpdateWsLotContainersUsageComponent>,
