...
export class WsLotContainersUsageService {
 ...
 constructor(private http: HttpClient, private cookieService: CookieService) {}
  ...
  onCreate(body: any) {
    ...
    let createUserURL = this.API_URL + 'limsws/wslcur-record/save-update';
    const httpOptions = {
 ...
 getDropDownList() {
    ...
    const ALLSALEPRODUCTURL =
      this.API_URL + 'limsws/wslcur-record/get-by-code-all' + queryParams;
