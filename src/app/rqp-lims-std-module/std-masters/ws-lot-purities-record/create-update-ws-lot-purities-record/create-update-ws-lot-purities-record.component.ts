...
@Component({
  selector: 'app-create-update-ws-lot-purities-record',
  standalone: false,
  templateUrl: './create-update-ws-lot-purities-record.component.html',
  styleUrl: './create-update-ws-lot-purities-record.component.scss'
})
export class CreateUpdateWsLotPuritiesRecordComponent implements OnInit, OnDestroy {
  isReadOnly = true;
  isUpdate = false;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<CreateUpdateWsLotPuritiesRecordComponent>,
 ...
 ngOnInit(): void {
  ...
  onLoadFormValue() {
    ...
    const params = { UC0001 };
    this.apiService
      .sendRequest(apiEndPoints.WlprLoadUpdatePage, 'POST', params)
      .subscribe((data: any) => {
