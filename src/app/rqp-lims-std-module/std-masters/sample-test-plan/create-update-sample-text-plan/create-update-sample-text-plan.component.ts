...
@Component({
  selector: 'app-create-update-sample-text-plan',
  standalone: false,
  templateUrl: './create-update-sample-text-plan.component.html',
  styleUrl: './create-update-sample-text-plan.component.scss'
})
export class CreateUpdateSampleTextPlanComponent implements OnInit {
  isReadOnly = true;
  isUpdate = false;
  ...
  constructor(
    ...
    private sampleRegestrationService: SampleTextPlanService,
    private apiService: ApiService,
    public dialogRef: MatDialogRef<CreateUpdateSampleTextPlanComponent>,
