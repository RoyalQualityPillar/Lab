...
@Component({
  selector: 'app-utm-create-update',
  standalone: false,
  templateUrl: './utm-create-update.component.html',
  styleUrl: './utm-create-update.component.scss'
})
export class UtmCreateUpdateComponent implements OnInit {
  isReadOnly = true;
  isUpdate = false;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<UtmCreateUpdateComponent>,
  ...
  onLoadFormValue() {
    ...
    this.apiService
      .sendRequest(apiEndPoints.UtmLoadUpdatePage, 'POST', params)
      .subscribe((data: any) => {
        if (data.data == null) {
          this.isLoading = false;
