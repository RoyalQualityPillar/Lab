...
import { SampleRegestrationService } from '../../sample-regestration/sample-regestration.service';
...
@Component({
  selector: 'app-purity-type-master-create-update',
  standalone: false,
  templateUrl: './purity-type-master-create-update.component.html',
  styleUrl: './purity-type-master-create-update.component.scss'
})
export class PurityTypeMasterCreateUpdateComponent    implements OnInit {
  isReadOnly = true;
  isUpdate = false;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<PurityTypeMasterCreateUpdateComponent>,
