...
@Component({
  selector: 'app-create-update-ws-lot-containers-record',
  standalone: false,
  templateUrl: './create-update-ws-lot-containers-record.component.html',
  styleUrl: './create-update-ws-lot-containers-record.component.scss'
})
export class CreateUpdateWsLotContainersRecordComponent implements OnInit, OnDestroy {
  isReadOnly = true;
  isUpdate = false;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<CreateUpdateWsLotContainersRecordComponent>,
 ...
 ngOnInit(): void {
  ...
  onLoadFormValue() {
    ...
    const params = { UC0001 };
    this.apiService
      .sendRequest(apiEndPoints.WlcrLoadUpdatePage, 'POST', params)
      .subscribe((data: any) => {
