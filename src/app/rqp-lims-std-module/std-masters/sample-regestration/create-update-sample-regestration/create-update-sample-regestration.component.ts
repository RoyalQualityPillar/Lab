...
@Component({
  selector: 'app-create-update-sample-regestration',
  standalone: false,
  templateUrl: './create-update-sample-regestration.component.html',
  styleUrl: './create-update-sample-regestration.component.scss'
})
export class CreateUpdateSampleRegestrationComponent implements OnInit {
  isReadOnly = true;
  isUpdate = false;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<CreateUpdateSampleRegestrationComponent>,
