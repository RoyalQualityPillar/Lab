...
@Component({
  selector: 'app-storage-conditio-master-create-update',
  standalone: false,
  templateUrl: './storage-conditio-master-create-update.component.html',
  styleUrl: './storage-conditio-master-create-update.component.scss'
})
export class StorageConditioMasterCreateUpdateComponent  implements OnInit {
  isReadOnly = true;
  isUpdate = false;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<StorageConditioMasterCreateUpdateComponent>,
    ...
    this.DepartmentMaster = this.fb.group({
      ...
      // ff0013: [0, Validators.required],
      // ff0014: [0, Validators.required],
      createdby: [''],
      status: [''],
  ...
  onLoadFormValue() {
    ...
    this.apiService
      .sendRequest(apiEndPoints.ScmaLoadUpdatePage, 'POST', params)
      .subscribe((data: any) => {
        if (data.data == null) {
          this.isLoading = false;
