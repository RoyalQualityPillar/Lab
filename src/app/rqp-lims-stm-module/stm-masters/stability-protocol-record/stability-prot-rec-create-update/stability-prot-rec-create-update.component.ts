...
@Component({
  selector: 'app-stability-prot-rec-create-update',
  standalone: false,
  templateUrl: './stability-prot-rec-create-update.component.html',
  styleUrl: './stability-prot-rec-create-update.component.scss'
})
export class StabilityProtRecCreateUpdateComponent implements OnInit {
  isReadOnly = true;
  isUpdate = false;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<StabilityProtRecCreateUpdateComponent>,
