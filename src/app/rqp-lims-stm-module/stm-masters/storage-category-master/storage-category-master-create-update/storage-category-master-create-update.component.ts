...
@Component({
  selector: 'app-storage-category-master-create-update',
  standalone: false,
  templateUrl: './storage-category-master-create-update.component.html',
  styleUrl: './storage-category-master-create-update.component.scss'
})
export class StorageCategoryMasterCreateUpdateComponent implements OnInit {
  isReadOnly = true;
  isUpdate = false;
