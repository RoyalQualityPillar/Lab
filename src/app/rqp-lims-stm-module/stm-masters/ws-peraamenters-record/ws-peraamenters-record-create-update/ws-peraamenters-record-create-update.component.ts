...
@Component({
  selector: 'app-ws-peraamenters-record-create-update',
  standalone: false,
  templateUrl: './ws-peraamenters-record-create-update.component.html',
  styleUrl: './ws-peraamenters-record-create-update.component.scss'
})
export class WsPeraamentersRecordCreateUpdateComponent implements OnInit {
  isReadOnly = true;
  isUpdate = false;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<WsPeraamentersRecordCreateUpdateComponent>,
  ...
  onLoadFormValue() {
    ...
    this.apiService
      .sendRequest(apiEndPoints.WsPeraamentersrecordLoadUpdatePage, 'POST', params)
      .subscribe((data: any) => {
        if (data.data == null) {
          this.isLoading = false;
