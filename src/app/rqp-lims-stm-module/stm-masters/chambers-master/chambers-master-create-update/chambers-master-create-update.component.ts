...
@Component({
  selector: 'app-chambers-master-create-update',
  standalone: false,
  templateUrl: './chambers-master-create-update.component.html',
  styleUrl: './chambers-master-create-update.component.scss'
})
export class ChambersMasterCreateUpdateComponent implements OnInit {
  isReadOnly = true;
  isUpdate = false;
