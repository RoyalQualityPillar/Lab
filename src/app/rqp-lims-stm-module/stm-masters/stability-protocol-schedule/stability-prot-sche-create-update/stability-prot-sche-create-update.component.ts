...
@Component({
  selector: 'app-stability-prot-sche-create-update',
  standalone: false,
  templateUrl: './stability-prot-sche-create-update.component.html',
  styleUrl: './stability-prot-sche-create-update.component.scss'
})
export class StabilityProtScheCreateUpdateComponent implements OnInit {
  isReadOnly = true;
  isUpdate = false;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<StabilityProtScheCreateUpdateComponent>,
  ...
  onLoadFormValue() {
    ...
    this.apiService
      .sendRequest(apiEndPoints.SpsLoadUpdatePage, 'POST', params)
      .subscribe((data: any) => {
        if (data.data == null) {
          this.isLoading = false;
