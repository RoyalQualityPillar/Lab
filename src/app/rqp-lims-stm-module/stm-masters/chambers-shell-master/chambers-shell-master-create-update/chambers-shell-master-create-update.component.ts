...
@Component({
  selector: 'app-chambers-shell-master-create-update',
  standalone: false,
  templateUrl: './chambers-shell-master-create-update.component.html',
  styleUrl: './chambers-shell-master-create-update.component.scss'
})
export class ChambersShellMasterCreateUpdateComponent implements OnInit {
  isReadOnly = true;
  isUpdate = false;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ChambersShellMasterCreateUpdateComponent>,
