...
@Component({
  selector: 'app-ws-template-index-create-update',
  standalone: false,
  templateUrl: './ws-template-index-create-update.component.html',
  styleUrl: './ws-template-index-create-update.component.scss'
})
export class WsTemplateIndexCreateUpdateComponent implements OnInit {
  isReadOnly = true;
  isUpdate = false;
...
,
    ...
    public dialogRef: MatDialogRef<WsTemplateIndexCreateUpdateComponent>,
