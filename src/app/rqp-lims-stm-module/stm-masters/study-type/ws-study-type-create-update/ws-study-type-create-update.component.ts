...
@Component({
  selector: 'app-ws-study-type-create-update',
  standalone: false,
  templateUrl: './ws-study-type-create-update.component.html',
  styleUrl: './ws-study-type-create-update.component.scss'
})
export class WsStudyTypeCreateUpdateComponent implements OnInit {
  isReadOnly = true;
  isUpdate = false;
