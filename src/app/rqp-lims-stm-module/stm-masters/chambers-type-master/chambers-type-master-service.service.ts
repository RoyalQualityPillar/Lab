...
export class ChambersTypeMasterServiceService {
   private API_URL = environment.apiBaseURL;
  constructor(private http: HttpClient, private cookieService: CookieService) {}
  
    onCreate(body: any) {
        let token = this.cookieService.get('token');
        let createUserURL = this.API_URL + 'limssm/ctm-master/save-update';
        const httpOptions = {
    ...
    const ALLSALEPRODUCTURL =
      this.API_URL + 'limssm/ctm-master/get-by-code-all' + queryParams;
