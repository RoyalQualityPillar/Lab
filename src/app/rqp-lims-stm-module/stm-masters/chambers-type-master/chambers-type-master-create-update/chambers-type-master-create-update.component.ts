...
@Component({
  selector: 'app-chambers-type-master-create-update',
  standalone: false,
  templateUrl: './chambers-type-master-create-update.component.html',
  styleUrl: './chambers-type-master-create-update.component.scss'
})
export class ChambersTypeMasterCreateUpdateComponent implements OnInit {
  isReadOnly = true;
  isUpdate = false;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ChambersTypeMasterCreateUpdateComponent>,
  ...
  onLoadFormValue() {
    ...
    this.apiService
      .sendRequest(apiEndPoints.CtmLoadUpdatePage, 'POST', params)
      .subscribe((data: any) => {
        if (data.data == null) {
          this.isLoading = false;
