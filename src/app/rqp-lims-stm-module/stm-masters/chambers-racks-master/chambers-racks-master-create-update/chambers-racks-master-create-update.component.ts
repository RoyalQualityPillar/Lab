...
@Component({
  selector: 'app-chambers-racks-master-create-update',
  standalone: false,
  templateUrl: './chambers-racks-master-create-update.component.html',
  styleUrl: './chambers-racks-master-create-update.component.scss'
})
export class ChambersRacksMasterCreateUpdateComponent implements OnInit {
  isReadOnly = true;
  isUpdate = false;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ChambersRacksMasterCreateUpdateComponent>,
