...
@Component({
  selector: 'app-ws-peramenters-create-update',
  standalone: false,
  templateUrl: './ws-peramenters-create-update.component.html',
  styleUrl: './ws-peramenters-create-update.component.scss'
})
export class WsPeramentersCreateUpdateComponent implements OnInit {
  isReadOnly = true;
  isUpdate = false;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<WsPeramentersCreateUpdateComponent>,
  ...
  onLoadFormValue() {
    ...
    this.apiService
      .sendRequest(apiEndPoints.WsPeramentersLoadUpdatePage, 'POST', params)
      .subscribe((data: any) => {
        if (data.data == null) {
          this.isLoading = false;
