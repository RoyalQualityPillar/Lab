...
export class ClrServiceService {
  ...
  constructor(private http: HttpClient, private cookieService: CookieService) {}
    ...
    onCreate(body: any) {
        ...
        let createUserURL = this.API_URL + 'limschm/chlr_record/save-update';
        const httpOptions = {
    ...
    const ALLSALEPRODUCTURL =
      this.API_URL + 'limschm/chlr_record/get-by-code-all' + queryParams;
