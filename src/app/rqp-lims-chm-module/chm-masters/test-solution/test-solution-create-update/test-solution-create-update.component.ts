...
@Component({
  selector: 'app-test-solution-create-update',
  standalone: false,
  templateUrl: './test-solution-create-update.component.html',
  styleUrl: './test-solution-create-update.component.scss'
})
export class TestSolutionCreateUpdateComponent implements OnInit {
  isReadOnly = true;
  isUpdate = false;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<TestSolutionCreateUpdateComponent>,
  ...
  onLoadFormValue() {
    ...
    this.apiService
      .sendRequest(apiEndPoints.TsrLoadUpdatePage, 'POST', params)
      .subscribe((data: any) => {
        if (data.data == null) {
          this.isLoading = false;
