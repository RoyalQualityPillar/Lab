...
import { CmrCreateUpdateComponent } from '../cmr-create-update/cmr-create-update.component';
import { MessageDialogComponent } from 'src/app/common/message-dialog/message-dialog.component';
import { changeStatusByCode } from 'src/app/common/removeEmptyStrings';
import { apiEndPoints } from 'src/app/service/api-service/api-endpoints.constant';

@Component({
  selector: 'app-cmr-home-page',
  standalone: false,
  templateUrl: './cmr-home-page.component.html',
  styleUrl: './cmr-home-page.component.scss'
})
export class CmrHomePageComponent implements OnInit, AfterViewInit {
  ...
  allCmrTableDataUrl: any;
  activeCmrTableDataUrl: any;
  filterApiUrl: any;
  params: any;
  HttpMethod = 'POST';
  getLatestData = false;
  ...
  constructor(
    ...
    private cmrServiceService: CmrServiceService,
  ...
  ngOnInit(): void {
    this.allCmrTableDataUrl = apiEndPoints.allCmrTabledata;
    this.pageIndex = 0;
  ...
  async loadRoleMasterTableFilter() {
    try {
      ...
      compRef.setInput('apiUrl', this.allCmrTableDataUrl);
      compRef.setInput('tableTitle', 'All Chemical Master Registration');
      ...
      compRef.setInput('downloadFileName', 'Chemical Master Registration');
  ...
  async loadActiveRoleMasterTableFilter() {
    try {
      ...
      console.error('Error loading Active  Chemical Master Registration table filter:', error);
    }
  }
  ...
  selectedRow: any;
  onOpenRolePOPUP() {
    const dialogRef = this.dialog.open(CmrCreateUpdateComponent, {
      minWidth: '80%',
  ...
  async onActiveSelectAuditRow() {
    let tableData = [
      ...
      { labelName: 'Chemical Code', value: this.selectedRow.uc0001 },
      { labelName: 'Chemical Name', value: this.selectedRow.ff0001 },
      { labelName: 'Cas No/CAT No', value: this.selectedRow.ff0002 },
      { labelName: 'Category', value: this.selectedRow.ff0003 },
      { labelName: 'Grade', value: this.selectedRow.ff0004 },
      { labelName: 'Handling Symbol', value: this.selectedRow.ff0005 },
      { labelName: 'storage Condition', value: this.selectedRow.ff0006 },
      { labelName: 'Alert Qty', value: this.selectedRow.ff0007 },
      { labelName: 'UOM', value: this.selectedRow.ff0008 },
      { labelName: 'Minimum Qty', value: this.selectedRow.ff0009 },
    ...
    const rows = apiResponse.map((item) => {
      return {
        fields: [
          ...
          { labelName: 'Chemical Code', value: item.uc0001 },
          { labelName: 'Chemical Name', value: item.ff0001 },
          { labelName: 'Cas no/CAT No', value: item.ff0002 },
          { labelName: 'Category', value: item.ff0003 },
          { labelName: 'Grade', value: item.ff0004 },
          { labelName: 'Handling Symbol', value: item.ff0005 },
          { labelName: 'Storage Condition', value: item.ff0006 },
          { labelName: 'Alert Qty', value: item.ff0007 },
          { labelName: 'UOM', value: item.ff0008 },
          { labelName: 'Minimum Qty', value: item.ff0009 },
  ...
  columnConfig = {
    action: 'Action',
    uc0001: 'Chemical Code',
    ff0001: 'Chemical Name',
    ff0002: 'Cas No/CAT No',
    ff0003: 'Category',
    // ff0004: 'Grade',
    // ff0005: 'Handling Symbol',
    // ff0006: 'Storage Condition',
    // ff0007: 'Alert Qty',
    // ff0008: 'UOM',
    // ff0009: 'Minimum Qty',
