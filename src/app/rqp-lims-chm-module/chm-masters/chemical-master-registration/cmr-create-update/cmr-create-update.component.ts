...
@Component({
  selector: 'app-cmr-create-update',
  standalone: false,
  templateUrl: './cmr-create-update.component.html',
  styleUrl: './cmr-create-update.component.scss'
})
export class CmrCreateUpdateComponent implements OnInit {
  isReadOnly = true;
  isUpdate = false;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<CmrCreateUpdateComponent>,
  ...
  onLoadFormValue() {
    ...
    this.apiService
      .sendRequest(apiEndPoints.CmrLoadUpdatePage, 'POST', params)
      .subscribe((data: any) => {
        if (data.data == null) {
          this.isLoading = false;
