...
@Component({
  selector: 'app-tsm-create-update',
  standalone: false,
  templateUrl: './tsm-create-update.component.html',
  styleUrl: './tsm-create-update.component.scss'
})
export class TsmCreateUpdateComponent implements OnInit {
  isReadOnly = true;
  isUpdate = false;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<TsmCreateUpdateComponent>,
  ...
  onLoadFormValue() {
    ...
    this.apiService
      .sendRequest(apiEndPoints.TsmLoadUpdatePage, 'POST', params)
      .subscribe((data: any) => {
        if (data.data == null) {
          this.isLoading = false;
