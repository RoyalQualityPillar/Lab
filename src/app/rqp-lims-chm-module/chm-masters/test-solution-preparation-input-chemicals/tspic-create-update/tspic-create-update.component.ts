...
@Component({
  selector: 'app-tspic-create-update',
  standalone: false,
  templateUrl: './tspic-create-update.component.html',
  styleUrl: './tspic-create-update.component.scss'
})
export class TspicCreateUpdateComponent implements OnInit {
  isReadOnly = true;
  isUpdate = false;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<TspicCreateUpdateComponent>,
  ...
  onLoadFormValue() {
    ...
    this.apiService
      .sendRequest(apiEndPoints.TspicLoadUpdatePage, 'POST', params)
      .subscribe((data: any) => {
        if (data.data == null) {
          this.isLoading = false;
