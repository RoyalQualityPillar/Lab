...
export class TspicmServiceService {
  ...
  constructor(private http: HttpClient, private cookieService: CookieService) {}
    ...
    onCreate(body: any) {
        ...
        let createUserURL = this.API_URL + 'limschm/chtsim_master/save-update';
        const httpOptions = {
    ...
    const ALLSALEPRODUCTURL =
      this.API_URL + 'limschm/chtsim_master/get-by-code-all' + queryParams;
