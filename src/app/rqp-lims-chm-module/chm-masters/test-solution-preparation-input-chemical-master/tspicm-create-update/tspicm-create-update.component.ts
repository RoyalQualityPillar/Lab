...
import { TsmServiceService } from '../../test-solution-master/tsm-service.service';
...
@Component({
  selector: 'app-tspicm-create-update',
  standalone: false,
  templateUrl: './tspicm-create-update.component.html',
  styleUrl: './tspicm-create-update.component.scss'
})
export class TspicmCreateUpdateComponent implements OnInit {
  isReadOnly = true;
  isUpdate = false;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<TspicmCreateUpdateComponent>,
  ...
  onLoadFormValue() {
    ...
    this.apiService
      .sendRequest(apiEndPoints.TspicmLoadUpdatePage, 'POST', params)
      .subscribe((data: any) => {
        if (data.data == null) {
          this.isLoading = false;
