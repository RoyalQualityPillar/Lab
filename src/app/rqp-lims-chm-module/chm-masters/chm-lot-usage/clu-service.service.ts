...
export class CluServiceService {
  ...
  constructor(private http: HttpClient, private cookieService: CookieService) {}
    ...
    onCreate(body: any) {
        ...
        let createUserURL = this.API_URL + '/limschm/chlur_record/save-update';
        const httpOptions = {
    ...
    const ALLSALEPRODUCTURL =
      this.API_URL + 'limschm/chlur_record/get-by-code-all' + queryParams;
