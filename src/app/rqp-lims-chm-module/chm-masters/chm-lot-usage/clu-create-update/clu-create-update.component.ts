...
@Component({
  selector: 'app-clu-create-update',
  standalone: false,
  templateUrl: './clu-create-update.component.html',
  styleUrl: './clu-create-update.component.scss'
})
export class CluCreateUpdateComponent implements OnInit {
  isReadOnly = true;
  isUpdate = false;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<CluCreateUpdateComponent>,
    @Inject(MAT_DIALOG_DATA) public userData: userData,
    private clrServiceService:  CluServiceService,
  ...
  onLoadFormValue() {
    ...
    this.apiService
      .sendRequest(apiEndPoints.CluLoadUpdatePage, 'POST', params)
      .subscribe((data: any) => {
        if (data.data == null) {
          this.isLoading = false;
